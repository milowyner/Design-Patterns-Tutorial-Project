...
public protocol QuestionViewControllerDelegate: class {
    func questionViewController(_ viewController: QuestionViewController, didCancel: QuestionGroup, at questionIndex: Int)
...
public class QuestionViewController: UIViewController {
    ...
    public lazy var questionIndexItem: UIBarButtonItem = {
